...
export default function NotFound() {
  return (
    <Container className="flex min-h-[70vh] flex-col items-center justify-center py-20 text-center">
      <span className="font-heading text-7xl font-extrabold text-main sm:text-9xl">
        404
      </span>
      ...
      <p className="mt-2 max-w-md text-foreground/60">
        Maaf, halaman yang kamu cari tidak ada atau sudah dipindahkan. Yuk
        kembali belanja akun premium favoritmu.
      </p>
