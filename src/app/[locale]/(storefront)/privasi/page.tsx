...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: "/privasi",
      languages: { id: "/privasi", en: "/en/privasi" },
    },
  }
}
...
const sections = [
  {
    ...
    bodyEn: "We collect the data you provide when ordering, such as your name, email, and WhatsApp number, along with the transaction details needed to process your order.",
  },
  {
    ...
    bodyEn: "Your data is used to process orders, deliver account details, provide customer support, and send important service-related information. We will not use your data beyond these purposes without consent.",
  },
  {
    ...
    bodyEn: "We apply reasonable security measures to protect your data, including encryption during payment. That said, no method of internet transmission is ever completely 100% secure.",
  },
  {
    ...
    bodyEn: "We do not sell your personal data. Data is only shared with trusted payment providers as needed to complete a transaction, or where required by law.",
  },
  {
    heading: "Cookie",
    headingEn: "Cookies",
    ...
    bodyEn: "We use cookies to improve your shopping experience, remember preferences, and analyze site traffic. You can manage cookies through your browser settings.",
  },
  {
    heading: "Hak Kamu",
    ...
    bodyEn: "You have the right to request access to, updates of, or deletion of your personal data. To do so, simply reach out to our team via the Contact page.",
  },
  {
    ...
    bodyEn: "This Privacy Policy may be updated at any time. The latest version will always be available on this page along with its update date.",
  },
]
