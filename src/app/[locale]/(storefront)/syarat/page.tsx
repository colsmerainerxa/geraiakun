...
const sections = [
  ...
  },
  {
    ...
    bodyEn:
      "Payments are made via QRIS, e-wallet, or available bank Virtual Accounts. Orders are processed once payment is automatically verified. Prices may change at any time without prior notice.",
  },
  {
    ...
    bodyEn:
      "Account details are delivered to your email and dashboard, usually instantly. Each account is covered by a warranty for its full duration. Faulty accounts will be replaced or repaired while the warranty is still valid.",
  },
  {
    heading: "Refund",
    headingEn: "Refunds",
    ...
    bodyEn:
      "If we cannot deliver an account or resolve an issue within the warranty period, you are entitled to a full refund or an equivalent replacement. Refunds do not apply to account misuse by the buyer.",
  },
  {
    ...
    bodyEn:
      "You must keep your account credentials confidential and must not change the email or password without our instruction. Misuse may void the warranty and your access to the service.",
  },
  {
    ...
    bodyEn:
      "We may update these Terms & Conditions at any time. Changes take effect once published on this page. Continued use of the service is considered acceptance of those changes.",
  },
]
