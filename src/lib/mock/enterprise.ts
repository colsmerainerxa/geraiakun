...
export const vaultAccounts: VaultAccount[] = [
  ...
  },
  {
    ...
    loginEmail: "vault.api.2035@geraiakun.dev",
    status: "ditahan",
...
export const fulfillmentTasks: FulfillmentTask[] = [
  {
    ...
    risk: "rendah",
    slaMinutes: 4,
    credentialEmail: "stock.chatgpt-plus.17@vault.geraiakun",
    channel: "dashboard",
  ...
  },
  {
    ...
    risk: "tinggi",
    slaMinutes: 11,
    credentialEmail: "stock.api-key.31@vault.geraiakun",
    channel: "whatsapp",
  ...
  },
  {
    ...
    risk: "rendah",
    slaMinutes: 0,
    credentialEmail: "stock.gemini-pro.22@vault.geraiakun",
    channel: "dashboard",
